...
namespace molumes
{
	...
	private:
		...
		void performAmbientOcclusion(glm::vec4 projectionInfo, const glm::ivec2 viewportSize, float projectionScale, const glm::mat4 modelViewMatrix, glm::vec4 worldLightPosition);
		void performShade(const glm::mat4 modelViewMatrix, const glm::mat4 modelViewProjectionMatrix, const glm::mat4 inverseModelViewProjectionMatrix, const glm::mat4 normalMatrix,
			const glm::mat4 inverseNormalMatrix, glm::vec4 worldLightPosition, glm::vec2 focusPosition);
		// --------------------------------------------------------------------------------
