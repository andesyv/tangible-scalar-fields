...
namespace molumes {
    ...
    public:
        ...
        virtual globjects::Program *getAccumulationProgram() = 0;

        virtual globjects::Program *getTileProgram() = 0;

        virtual globjects::Program *getTileNormalsProgram() = 0;

        virtual globjects::Program *getGridProgram() = 0;
        ...
        virtual void calculateNumberOfTiles(glm::vec3 boundingBoxSize, glm::vec3 minBounds) = 0;
        ...
        virtual int mapPointToTile1D(glm::vec2 p) = 0;
    ...
    protected:
        ...
        static int mapInterval(float x, float a, float b, int c) {
            return int((x - a) * static_cast<float>(c) / (b - a));
        }
